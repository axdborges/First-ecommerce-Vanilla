        ...
        if (button.id == i ) {
            listaCart.insertAdjacentHTML("beforeend", 
                `<li class= "newPdt">
                    ...
                    <br>
                    <p class="priceCart"> ${data[i-1].value} </p>
...
// Colocando a quantidade (usar afterend)

    // const qtdCart = document.querySelector(".listaCart").length
    // const precoNoCart = document.querySelector(".priceCart")
    // const totalVendas = 0

    // for (let i = 0; i < qtdCart; i++) {

    //     totalVendas += precoNoCart[i]
